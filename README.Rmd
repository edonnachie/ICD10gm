...
The ICD-10-GM metadaa are provided in four data.frames as follows:

- `icd_meta_chapters`: A list of ICD-10 chapters
...
A helper function `get_icd_labels` returns only the ICD subcodes and labels for specified codes and years.
