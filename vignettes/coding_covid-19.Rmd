...
A [flyer illustrating various coding scenarios](https://www.zi.de/fileadmin/images/content/Kodierhilfe/COVID-Flyer_Kodierhilfe_2021-03-16.pdf) has also been issued by Zi, the health services research institute of the KBV.
...
As long covid (U09.9!) is a secondary code, it should be accompanied by a primary code specifying the nature of the complaint. In practice, this may be a symptom, a disease resulting from the infection, or a code relating to a functional or psychiatric condition, for example:

- F48.0: Neurasthenia
- G83.3: Chronic fatigue syndrome
- F41: Anxiety
