...
subtitle: "Status: Draft, incomplete"
...
read_html("https://www.dimdi.de/static/de/klassifikationen/icd/icd-10-gm/kode-suche/htmlgm2018/block-a00-a09.htm") %>% 
  ...
  arrange(icd_sub) %>% 
  left_join(
    ICD10gm::get_icd_labels(year = 2018)[, c("icd_sub", "icd_normcode", "label")],
    by = "icd_sub") %>% 
...
To the authors knowledge, this package represents the only publically available respsitory of pre-processed metadata for the ICD-10-GM. Indeed, a key contribution of the package is the compilation and processing of the metadata provided by DIMDI, which is designed more for the needs of operational use than for the purpose of longitidinal secondary data analysis.
