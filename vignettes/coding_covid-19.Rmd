...
In order to document the Covid-19 pandemic, a number of emergency codes were introduced in the course of 2020. These are incorporated in the `ICD10gm` package, both as additions to the 2020 version and via use of the updated 2021 version. This vignette describes the usage of these codes with links to the official documentation mandating their use in Germany.
